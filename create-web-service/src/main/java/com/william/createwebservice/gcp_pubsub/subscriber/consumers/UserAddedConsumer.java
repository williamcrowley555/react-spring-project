...
@Component
public class UserAddedConsumer extends PubSubConsumer {
    private static final Logger LOGGER = LoggerFactory.getLogger(UserAddedConsumer.class);

    @Override
    public String subscription() {
        return "user-added-sub";
    }
    ...
    protected void consume(BasicAcknowledgeablePubsubMessage acknowledgeablePubsubMessage) throws JsonProcessingException {
        ...
        userSocketModule.emit(UserSocketModule.TOPIC_USER_ADDED,
